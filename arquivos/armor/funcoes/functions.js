...
const ceemde = JSON.parse(fs.readFileSync('./arquivos/data/totalcmd.json'));
...
const banner2 = cfonts.render(('INSTAGRAM.COM/@EUYATO'), {
font: 'console',
align: 'center',
gradrient: [`${cor4}`,`${cor2}`], 
...
const banner3 = cfonts.render((`ANGEL\nBASE`), {
font: 'slick',             
align: 'center',           
...
authorname = 'ANGEL-3.0'
packname = 'euyato'

const usedCommandRecently = new Set()

chyt = `558892153207@s.whatsapp.net`
