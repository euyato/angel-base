...
const banner2 = cfonts.render((`Insta: https://instagram.com/euyato\nCriador: +55 88 9348-7916\n`), {
font: 'console',
align: 'center',
colors: 'cyan'
});
 
const banner3 = cfonts.render((`TSUKINO|MD`), {
  font: 'block',
  align: "center",
  colors: [`cyan`,`${cor3}`,`${cor4}`,`${cor2}`],
...
const authorname = "Tsukino Multi-Device"
const packname = "Criador: @astrxno"

const chyt = "558893487916@s.whatsapp.net";
const nit = "558893487916@s.whatsapp.net";
const supre = "558893487916@s.whatsapp.net";
